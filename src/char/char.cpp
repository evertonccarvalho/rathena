...
int32 char_mmo_char_fromsql(uint32 char_id, struct mmo_charstatus* p, bool load_everything) {
	...
	if( SQL_ERROR == stmt.Prepare("SELECT `top_damage`,`damage_done`,`damage_received`,`skulls`,`ti_wins`,`ti_lost`,`ti_tie`,`eos_flags`,`eos_bases`,`eos_wins`,`eos_lost`,`eos_tie`,`boss_killed`,`boss_damage`,`boss_flags`,`boss_wins`,`boss_lost`,`boss_tie`,`td_kills`,`td_deaths`,`td_wins`,`td_lost`,`td_tie`,`dom_bases`,`dom_off_kills`,`dom_def_kills`,`dom_wins`,`dom_lost`,`dom_tie`,`sc_stole`,`sc_captured`,`sc_droped`,`sc_wins`,`sc_lost`,`sc_tie`,`ctf_taken`,`ctf_captured`,`ctf_droped`,`ctf_wins`,`ctf_lost`,`ctf_tie`,`emperium_kill`,`barricade_kill`,`gstone_kill`,`cq_wins`,`cq_lost`,`ru_wins`,`ru_lost`,`ru_captures`,`kill_count`,`death_count`,`win`,`lost`,`tie`,`leader_win`,`leader_lost`,`leader_tie`,`deserter`,`score`,`points`,`rank_points`,`rank_games`,`sp_heal_potions`,`hp_heal_potions`,`yellow_gemstones`,`red_gemstones`,`blue_gemstones`,`poison_bottles`,`acid_demostration`,`acid_demostration_fail`,`support_skills_used`,`healing_done`,`wrong_support_skills_used`,`wrong_healing_done`,`sp_used`,`zeny_used`,`spiritb_used`,`ammo_used`,`showstats` FROM `char_bg` WHERE `char_id` = ?")
		...
		|| SQL_ERROR == stmt.BindColumn(3, SQLDT_UINT16, &p->bgstats.skulls, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(4, SQLDT_UINT16, &p->bgstats.ti_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(5, SQLDT_UINT16, &p->bgstats.ti_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(6, SQLDT_UINT16, &p->bgstats.ti_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(7, SQLDT_UINT16, &p->bgstats.eos_flags, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(8, SQLDT_UINT16, &p->bgstats.eos_bases, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(9, SQLDT_UINT16, &p->bgstats.eos_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(10, SQLDT_UINT16, &p->bgstats.eos_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(11, SQLDT_UINT16, &p->bgstats.eos_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(12, SQLDT_UINT16, &p->bgstats.boss_killed, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(13, SQLDT_UINT32,   &p->bgstats.boss_damage, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(14, SQLDT_UINT16, &p->bgstats.boss_flags, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(15, SQLDT_UINT16, &p->bgstats.boss_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(16, SQLDT_UINT16, &p->bgstats.boss_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(17, SQLDT_UINT16, &p->bgstats.boss_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(18, SQLDT_UINT16, &p->bgstats.td_kills, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(19, SQLDT_UINT16, &p->bgstats.td_deaths, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(20, SQLDT_UINT16, &p->bgstats.td_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(21, SQLDT_UINT16, &p->bgstats.td_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(22, SQLDT_UINT16, &p->bgstats.td_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(23, SQLDT_UINT16, &p->bgstats.dom_bases, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(24, SQLDT_UINT16, &p->bgstats.dom_off_kills, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(25, SQLDT_UINT16, &p->bgstats.dom_def_kills, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(26, SQLDT_UINT16, &p->bgstats.dom_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(27, SQLDT_UINT16, &p->bgstats.dom_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(28, SQLDT_UINT16, &p->bgstats.dom_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(29, SQLDT_UINT16, &p->bgstats.sc_stole, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(30, SQLDT_UINT16, &p->bgstats.sc_captured, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(31, SQLDT_UINT16, &p->bgstats.sc_droped, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(32, SQLDT_UINT16, &p->bgstats.sc_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(33, SQLDT_UINT16, &p->bgstats.sc_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(34, SQLDT_UINT16, &p->bgstats.sc_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(35, SQLDT_UINT16, &p->bgstats.ctf_taken, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(36, SQLDT_UINT16, &p->bgstats.ctf_captured, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(37, SQLDT_UINT16, &p->bgstats.ctf_droped, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(38, SQLDT_UINT16, &p->bgstats.ctf_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(39, SQLDT_UINT16, &p->bgstats.ctf_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(40, SQLDT_UINT16, &p->bgstats.ctf_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(41, SQLDT_UINT16, &p->bgstats.emperium_kill, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(42, SQLDT_UINT16, &p->bgstats.barricade_kill, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(43, SQLDT_UINT16, &p->bgstats.gstone_kill, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(44, SQLDT_UINT16, &p->bgstats.cq_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(45, SQLDT_UINT16, &p->bgstats.cq_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(46, SQLDT_UINT16, &p->bgstats.ru_wins, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(47, SQLDT_UINT16, &p->bgstats.ru_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(48, SQLDT_UINT16, &p->bgstats.ru_captures, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(49, SQLDT_UINT16, &p->bgstats.kill_count, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(50, SQLDT_UINT16, &p->bgstats.death_count, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(51, SQLDT_UINT16, &p->bgstats.win, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(52, SQLDT_UINT16, &p->bgstats.lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(53, SQLDT_UINT16, &p->bgstats.tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(54, SQLDT_UINT16, &p->bgstats.leader_win, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(55, SQLDT_UINT16, &p->bgstats.leader_lost, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(56, SQLDT_UINT16, &p->bgstats.leader_tie, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(57, SQLDT_UINT16, &p->bgstats.deserter, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(58, SQLDT_UINT16, &p->bgstats.score, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(59, SQLDT_UINT16, &p->bgstats.points, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(60, SQLDT_UINT16, &p->bgstats.rank_points, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(61, SQLDT_UINT16, &p->bgstats.rank_games, 0, NULL, NULL)
		...
		|| SQL_ERROR == stmt.BindColumn(78, SQLDT_UINT16, &p->bgstats.showstats, 0, NULL, NULL)
	...
	if( SQL_ERROR == stmt.Prepare("SELECT `top_damage`, `damage_done`, `damage_received`, `emperium_damage`, `guardian_damage`, `barricade_damage`, `gstone_damage`, `emperium_kill`, `guardian_kill`, `barricade_kill`, `gstone_kill`, `sp_heal_potions`, `hp_heal_potions`, `yellow_gemstones`, `red_gemstones`, `blue_gemstones`, `poison_bottles`, `acid_demostration`, `acid_demostration_fail`, `support_skills_used`, `healing_done`, `wrong_support_skills_used`, `wrong_healing_done`, `sp_used`, `zeny_used`, `spiritb_used`, `ammo_used`, `kill_count`, `death_count`, `score`, `points`, `showstats` FROM `char_wstats` WHERE `char_id` = ?")
		...
		|| SQL_ERROR == stmt.BindColumn(7, SQLDT_UINT16, &p->wstats.emperium_kill, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(8, SQLDT_UINT16, &p->wstats.guardian_kill, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(9, SQLDT_UINT16, &p->wstats.barricade_kill, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(10, SQLDT_UINT16, &p->wstats.gstone_kill, 0, NULL, NULL)
		...
		|| SQL_ERROR == stmt.BindColumn(27, SQLDT_UINT16, &p->wstats.kill_count, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(28, SQLDT_UINT16, &p->wstats.death_count, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(29, SQLDT_UINT16, &p->wstats.score, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(30, SQLDT_UINT16, &p->wstats.points, 0, NULL, NULL)
		|| SQL_ERROR == stmt.BindColumn(31, SQLDT_UINT16, &p->wstats.showstats, 0, NULL, NULL)
		|| SQL_SUCCESS != stmt.NextRow() )
	{
